...
def build_exam_data_from_cart(cfg, cart):
    """장바구니 → exam_data 리스트 변환.
    cart: {passage_id: set(question_ids) or empty_set(=전체)}
    반환: [{"pid", "passage", "questions", "info", "answer_text"}, ...]
    """
    exam_data = []
    all_qids = []
