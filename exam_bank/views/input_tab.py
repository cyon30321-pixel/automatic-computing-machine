        ...
        def do_save():
            ...
            for item in parsed:
                ...
                create_passage(
                    ...
                    category1=self.combo_cat1.get(),
                    category2=self.combo_cat2.get(),
                    school_year=self.combo_year.get(),
                    exam_year=self.combo_exam_year.get(),
                    exam_month=self.combo_exam_month.get(),
                    publisher=self.ent_pub.get(),
                    extra_tags=extra,
                    answer_text=ans_raw,
